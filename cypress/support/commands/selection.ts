...
Cypress.Commands.add('setSelection', { prevSubject: true }, (subject: Element | JQuery<Element>, query: string, endQuery: string) => {
    return cy.wrap(subject)
        .selection($el => {
...
Cypress.Commands.add('setCursor', { prevSubject: true }, (subject: Element | JQuery<Element>, query: string, atStart: boolean = false) => {
    return cy.wrap(subject)
        .selection($el => {
...
Cypress.Commands.add('setCursorBefore', { prevSubject: true }, (subject: Element | JQuery<Element>, query: string) => {
    cy.wrap(subject).setCursor(query, true);
});

Cypress.Commands.add('setCursorAfter', { prevSubject: true }, (subject: Element | JQuery<Element>, query: string) => {
    cy.wrap(subject).setCursor(query);
});

// Helper functions
function getTextNode(el: Element, match: string = null) {
